<template>
  <div class="gsap">
    ...
    .from(box2, 3, { x: 100 }, '+=1') // delay - Retarda 1s o inicio da animação em relação à anterior
    .from(box3, 4, { x: 200 }, '-=1') // overlap - Adianta 1s o inicio da animação em relação à anterior
    .from(box4, 2, { x: 300 }, 2) // position absolute: Conta o tempo absoluto (..., 2) para a animação começar
    .from(otherBox1 , 3, { x: 400 }, 'box2Appear')
    .from(otherBox2 , 1, { x: 500 }, 5, 'box2Appear+=3')
  }
